...
# +
PATH = "some_nice_models/7395_loop2_ssdwip016dsy/checkpoints/epoch=149-step=30599.ckpt"
...
print("dropout ",model_['hyper_parameters']['dropout'])
print("num_layers ",model_['hyper_parameters']['num_layers'])
print("hidden_size ",model_['hyper_parameters']['hidden_size'])
print("n_features ",model_['hyper_parameters']['n_features'])
print("criterion ",model_['hyper_parameters']['criterion'])
print("batch_size ",model_['hyper_parameters']['batch_size'])
...
machines_model = ['client14dsy', 'client14xdsy', 'cmibuild1dsy', 'dell1843dsy',
       ...
       'enowip05dsy', 'enowip06dsy', 'enowip07dsy', 'enowip08dsy',
       'enowip09dsy', 'enowip10dsy', 'enowip11dsy', 'enowip12dsy',
       'enowip13dsy', 'enowip14dsy', 'enowip15dsy', 'infra14xdsy',
       'infra15dsy', 'pool05dsy', 'pool06dsy', 'pool08dsy', 'pool09dsy',
       'pool10dsy', 'pool11dsy', 'pool12dsy', 'pool13dsy', 'pool14dsy',
       'pool15dsy', 'pool23dsy', 'pool24dsy', 'pool26dsy', 'pool27dsy',
       'pool28dsy', 'pool29dsy', 'pool30dsy', 'pool32dsy', 'pool33dsy',
       'pool34dsy', 'pool35dsy', 'pool36dsy', 'pool37dsy', 'pool38dsy',
       'pool39dsy', 'pool40dsy', 'pool43dsy', 'pool44dsy', 'pool45dsy',
       'pool46dsy', 'pool47dsy', 'pool48dsy', 'pool49dsy', 'pool50dsy',
       'pool51dsy', 'pool52dsy', 'pool53dsy', 'pool55dsy', 'pool56dsy',
       'pool59dsy', 'pool60dsy', 'preint2017xdsy', 'ssdclient15xdsy',
       'ssdhwip001dsy', 'ssdhwip002dsy', 'ssdhwip003dsy', 'ssdhwip004dsy',
       'ssdhwip005dsy', 'ssdhwip006dsy', 'ssdhwip007dsy', 'ssdhwip008dsy',
       'ssdhwip009dsy', 'ssdhwip011dsy', 'ssdhwip012dsy', 'ssdhwip013dsy',
       ...
       'ssdwip008dsy', 'ssdwip009dsy', 'ssdwip023dsy', 'ssdwip024dsy',
       ...
       'wip148dsy', 'wip149dsy', 'wip150dsy', 'wip152dsy', 'wip153dsy',
       'wip154dsy', 'wip155dsy', 'wip156dsy', 'wip160dsy', 'wip161dsy',
       'wip163dsy', 'wip164dsy', 'wip165dsy', 'wip167dsy', 'wip168dsy',
       ...
       'wip198dsy', 'wip199dsy', 'wip200dsy', 'wip201dsy', 'wip203dsy',
       'wip204dsy', 'wip205dsy', 'wip207dsy', 'wip208dsy', 'wip210dsy',
       'wip212dsy', 'wip213dsy', 'wip214dsy', 'wip215dsy', 'wip216dsy',
       'wip219dsy', 'wip220dsy', 'wip222dsy', 'wip230dsy', 'wip233dsy',
       'wip234dsy', 'wip237dsy', 'wip238dsy', 'wip239dsy', 'wip241dsy',
       'wip242dsy', 'wip243dsy', 'wip244dsy', 'wip245dsy', 'wip246dsy',
       'wip247dsy', 'wip248dsy', 'wip249dsy', 'wip250dsy', 'wip251dsy',
       'wip254dsy', 'wip255dsy', 'wip256dsy', 'wip257dsy', 'wip258dsy',
       'wip259dsy', 'wip261dsy', 'wip262dsy', 'wip263dsy', 'wip264dsy',
       'wip265dsy', 'wip266dsy', 'wip267dsy', 'wip277dsy', 'wip278dsy',
       'wip279dsy', 'wip284dsy', 'wip285dsy', 'wip300dsy', 'wip302dsy',
       'wip303dsy', 'wip305dsy', 'wip310dsy', 'wip311dsy', 'wip312dsy',
       'wip313dsy', 'wip314dsy', 'wip315dsy', 'wip316dsy', 'wip317dsy',
       'wip318dsy', 'wip319dsy', 'wip320dsy', 'wip322dsy', 'wip323dsy',
       'wip326dsy', 'wip327dsy', 'wip328dsy', 'wip329dsy', 'wip330dsy',
       'wip331dsy', 'wip332dsy', 'wip333dsy', 'wip334dsy', 'wip335dsy',
       'wip336dsy', 'wip337dsy', 'wip338dsy', 'wip339dsy', 'wip340dsy',
       'wip342dsy', 'wip343dsy', 'wip344dsy', 'wip345dsy', 'wip346dsy',
       'wip347dsy', 'wip348dsy', 'wip350dsy', 'wip351dsy', 'wip352dsy',
       'wip353dsy', 'wip354dsy', 'wip355dsy', 'wip356dsy', 'wip357dsy',
       'wip358dsy', 'wip359dsy', 'wip360dsy', 'wip361dsy', 'wip363dsy',
       'wip370dsy', 'wip270dsy', 'pool31dsy']
...
#     'start_date': datetime.now() - timedelta(weeks = 8),
    'start_date': datetime(2021, 5, 11, 18, 13, 29, 150011),
    # datetime
    'end_date': datetime(2021, 7, 13, 18, 13, 29, 150011),
#     'end_date': None,
    # 'windows', 'linux'
    'os': 'windows',
    # List of host names
    ...
    # List of host names
    'machines_to_exclude': ['wip132dsy', 'ssdhwip010dsy', 'ssdwip017dsy', 'ssdwip018dsy', 'ssdwip020dsy', 'ssdwip021dsy', 'ssdwip022dsy'],
...
df[(df.Projet=="RelOps") & (df.Role == "Build Win")].Name.to_list()
